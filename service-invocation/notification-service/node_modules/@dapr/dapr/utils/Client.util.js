...
exports.createHTTPMetadataQueryParam = exports.createGRPCMetadata = void 0;
 ...
 */
function createGRPCMetadata(metadata = {}) {
 ...
 */
function createHTTPMetadataQueryParam(metadata = {}) {
    let queryParam = "";
    for (const [key, value] of Object.entries(metadata)) {
...
exports.createHTTPMetadataQueryParam = createHTTPMetadataQueryParam;
