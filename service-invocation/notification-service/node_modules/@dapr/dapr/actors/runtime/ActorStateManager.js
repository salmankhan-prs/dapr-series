...
class ActorStateManager {
    ...
    tryAddState(stateName, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const didExist = yield this.actor.getStateProvider().containsState(this.actor.getActorType(), this.actor.getActorId(), stateName);
            if (!didExist) {
                return false;
            }
    ...
    tryGetState(stateName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [hasValue, value] = yield this.actor.getStateProvider().tryLoadState(this.actor.getActorType(), this.actor.getActorId(), stateName);
            if (hasValue) {
    ...
    containsState(stateName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const doesContainState = yield this.actor.getStateProvider().containsState(this.actor.getActorType(), this.actor.getActorId(), stateName);
    ...
    addOrUpdateState(stateName, value, updateValueFactory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [hasValue, val] = yield this.actor.getStateProvider().tryLoadState(this.actor.getActorType(), this.actor.getActorId(), stateName);
            if (hasValue) {
