...
class StateProvider {
    ...
    containsState(actorType, actorId, stateName) {
        return __awaiter(this, void 0, void 0, function* () {
            const rawStateValue = yield this.actorClient.actor.stateGet(actorType, actorId, stateName);
    ...
    tryLoadState(actorType, actorId, stateName) {
        return __awaiter(this, void 0, void 0, function* () {
            const rawStateValue = yield this.actorClient.actor.stateGet(actorType, actorId, stateName);
     ...
     * @param stateChanges
     */
    saveState(actorType, actorId, stateChanges) {
        return __awaiter(this, void 0, void 0, function* () {
            const jsonOutput = [];
            ...
            yield this.actorClient.actor.stateTransaction(actorType, actorId, jsonOutput);
        });
    }
}
