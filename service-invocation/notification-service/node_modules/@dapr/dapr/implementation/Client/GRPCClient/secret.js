...
class GRPCClientSecret {
    constructor(client) {
        this.client = client;
    }
    // @todo: implement metadata
    get(secretStoreName, key, _metadata = "") {
        return __awaiter(this, void 0, void 0, function* () {
            const msgService = new dapr_pb_1.GetSecretRequest();
    ...
    getBulk(secretStoreName) {
        return __awaiter(this, void 0, void 0, function* () {
            const msgService = new dapr_pb_1.GetBulkSecretRequest();
            msgService.setStoreName(secretStoreName);
            const client = yield this.client.getClient();
            return new Promise((resolve, reject) => {
